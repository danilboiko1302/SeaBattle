...
public class MainMenu {
    ...
    public boolean canShipsFitOnBoard(){
        ...
        int totalShipSize = GameLogic.battleshipCount*(GameLogic.battleshipCount * GameLogic.battleshipSize)  +
                GameLogic.cruiserCount*(GameLogic.cruiserCount * GameLogic.cruiserSize) +
                GameLogic.destroyerCount*(GameLogic.destroyerCount * GameLogic.destroyerSize)  +
                GameLogic.submarineCount*(GameLogic.submarineCount * GameLogic.submarineSize);
    ...
    public void loadTitleScreen() {
        ...
        gameVSCam = new JButton("VS com = true");

        gameVSCam.setSize(150, 50);
        gameVSCam.setLocation(175, bkgImageContainer.getHeight() + 100-100);
        gameVSCam.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if(gameVSCam.getText().equals("VS com = true")){
                    gameVSCam.setText("VS com = false");
                }else
                    gameVSCam.setText("VS com = true");
            }
        });
        ...
        startGame.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                window.getContentPane().remove(gameVSCam);
        ...
        window.getContentPane().add(gameVSCam);
